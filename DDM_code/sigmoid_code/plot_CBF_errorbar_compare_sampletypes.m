function [ hf ] = plot_CBF_errorbar_compare_sampletypes( MergedData, BoxSizeIndex, colormapname )
...
% colormap
if nargin < 3 || isempty(colormapname) || ~ischar(colormapname) || ~exist(colormapname,'file')
...
% how many axes? 1 (this is an errorbar)
nax = 1;
xloff = 0.1;
xroff = 0.05;
yboff = 0.15;
